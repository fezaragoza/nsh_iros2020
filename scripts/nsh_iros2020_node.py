...
class Agent(object):
    def __init__(self):
        ...
        self.odom_list = list()
        self.odom_sub = rospy.Subscriber('ego_nshmx/odom', Odometry, self.odom_callback, queue_size=1)
        self.scan_sub = rospy.Subscriber('ego_nshmx/scan', LaserScan, self.scan_callback, queue_size=1)
        self.drive_pub = rospy.Publisher('ego_nshmx/drive', AckermannDriveStamped, queue_size=1)
